...
import com.canace.mybaby.adapter.PagerAdapter;
...
public class ImageViewPager extends ViewGroup {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		if (action == MotionEvent.ACTION_CANCEL
			...
			if (mIsBeingClicked && mOnClickListener != null) {
		...
		case MotionEvent.ACTION_MOVE: {
			...
			boolean flag = mAdapter.getViewFromIndex(mCurItem).isMoveOut();
			if (xDiff > mTouchSlop && xDiff > yDiff && flag) {
				if (DEBUG)
